...
def converter_utf8_arq_ft():
    ...
    try:
        ...
        if len(Items) != 0:
            print_divisor_inicio_fim('Arquivos da FT que serão convertidos e separados caso necessário: ',
                                     1)
...
def inserir_dados_ft_bd():
    ...
    try:
        ...
        leitura_csv_insercao_bd_sql('tb_sgi_ft_2012_2022',
                                    'tb_sgi_ft_2012_2022',
                                    table_create_sql_ft,
                                    'ft',
                                    output_files_files_convert)
...
def sequencia_ft():
    ...
    try:
        ...
        funçao_barprogress([converter_utf8_arq_ft,
                            inserir_dados_ft_bd,
                            criar_indices_ft],
                           'red')
        ...
        print_parcial_final_log_inf_retorno(f'inserção no banco e crição de chaves primárias e estrangeiras nas tabelas de FT na {base_dados}',
                                            insert_start,
                                            insert_end,
                                            '',
                                            'geral')
