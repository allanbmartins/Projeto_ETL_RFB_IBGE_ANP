...
def quantidade_populacao_IBGE():
    ...
    try:
        ...
        tmp_1 = pd.read_csv(file_path_ori,
                            # index_col=False,
                            sep=';',
                            encoding='Utf8')
        ...
        tmp_1 = tmp_1.drop(columns=['cod_municipio_ibge',
                                    'nome_municipio'])

        # Agrupando por item e contando o número de ocorrências
        tmp_1 = tmp_1.groupby(
            ['uf'])['Populacao_2022'].sum().reset_index(name='qtd_populacao')

        tmp_1 = unir_valores_linhas_df_go(tmp_1,
                                          'uf',
                                          'DF',
                                          'GO')
...
def quantidade_municipios_IBGE():
    ...
    try:
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['cod_tom',
                                    'cod_ibge',
                                    'muni_tom',
                                    'muni_ibge'])
        ...
        # Agrupando por item e contando o número de ocorrências
        tmp_1 = tmp_1.groupby(
            ['uf']).size().reset_index(name='qtd_municipios')
...
def valor_pib_industrial_IBGE():
    ...
    try:
        ...
        # Agrupando por item e contando o número de ocorrências
        tmp_1 = tmp_1.groupby(
            ['uf'])['pib_ind_2020'].sum().reset_index()
...
def valor_area_territorial_IBGE():
    ...
    try:
        ...
        # Alterar o nome da coluna
        tmp_1.columns = ['cod_ibge',
                         'area_territorial_km2',
                         'nome_municipio',
                         'uf']

        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['cod_ibge',
                                    'nome_municipio'])

        # Agrupando por item e contando o número de ocorrências
        tmp_1 = tmp_1.groupby(
            ['uf'])['area_territorial_km2'].sum().reset_index(name='area_territorial_km2')
...
def unidades_conservacao_ICMBIO():
    ...
    try:
        ...
        tmp_AREA_COMSERV = pd.read_csv(file_path,
                                       # index_col=False,
                                       sep=';',
                                       encoding='latin-1')

        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_AREA_COMSERV = tmp_AREA_COMSERV.drop(columns=['Cód. CNUC',
                                                          'Nome da UC',
                                                          'Categoria',
                                                          'Coord. Regional',
                                                          'Ano/Criação',
        ...
        # Alterar o nome da coluna
        tmp_AREA_COMSERV.columns = ['area_hectar',
                                    'uf']

        # Remover/Substituir caracteres "." e "" especiais coluna  específica
        tmp_AREA_COMSERV['area_hectar'] = tmp_AREA_COMSERV['area_hectar'].str.replace(
            '.', '')
        ...
        tmp_AREA_COMSERV['area_hectar'] = tmp_AREA_COMSERV['area_hectar'].round(
            0)
        ...
        tmp_AREA_COMSERV = dividir_linhas(tmp_AREA_COMSERV,
                                          'uf',
                                          '/',
                                          'area_hectar')
        ...
        tmp_AREA_COMSERV = tmp_AREA_COMSERV.groupby(
            ['uf'])['area_hectar_2'].sum().reset_index()

        tmp_AREA_COMSERV = unir_valores_linhas_df_go(tmp_AREA_COMSERV,
                                                     'uf',
                                                     'DF',
                                                     'GO')
        ...
        tmp_1 = pd.merge(
            tmp_1, tmp_AREA_COMSERV[['uf', 'area_territorio_ambiental_km2']], on='uf', how='left')

        # Aplicar a função para criação de coluna de escala e percentual
        tmp_1 = coluna_escala_p_n(tmp_1,
                                  1,
                                  'area_territorio_ambiental_km2')

       # Criar coluna com área total sem área de conservação
        tmp_1['area_territorial_sem_conserv_km2'] = ((tmp_1['area_territorial_km2']) -
...
def municipios_faixas_fronteiras_IBGE_GEO():
    ...
    try:
        ...
        tmp_1 = pd.read_excel(file_path,
                              sheet_name='Planilha1')

        # Alterar o nome da coluna
        tmp_1.columns = ['cod_mun',
                         'nome_regiao',
                         'cod_uf',
                         'nome_uf',
                         'uf',
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1_qtd_muni = tmp_1.drop(columns=['cod_mun',
                                             'nome_regiao',
                                             'cod_uf',
                                             'nome_uf',
                                             'area_total',
        ...
        tmp_1_qtd_muni = tmp_1_qtd_muni.groupby(
            ['uf'])['nome_mun'].nunique().reset_index(name='qtd_municipios_faxia_fronteira')

        tmp_1_qtd_muni = unir_valores_linhas_df_go(tmp_1_qtd_muni,
                                                   'uf',
                                                   'DF',
                                                   'GO')
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1_valor_area_int_km2 = tmp_1.drop(columns=['cod_mun',
                                                       'nome_regiao',
                                                       'cod_uf',
                                                       'nome_uf',
                                                       'nome_mun',
        ...
        # Agrupando por item e contando o número de ocorrências
        tmp_1_valor_area_int_km2 = tmp_1_valor_area_int_km2.groupby(
            ['uf'])['area_integrada_mun_faixa_fronteira_km2'].sum().reset_index()

        tmp_1_valor_area_int_km2 = unir_valores_linhas_df_go(tmp_1_valor_area_int_km2,
                                                             'uf',
                                                             'DF',
                                                             'GO')
        ...
        tmp_1_municipios = pd.read_csv(file_path_1,
                                       # index_col=False,
        ...
        # Unir datafremes
        tmp_1 = pd.merge(tmp_1_qtd_muni, tmp_1_municipios,
                         how='right', on='uf')

        # print(tmp_1)

        # Criar coluna com a cobertura de fibra por municipios
        tmp_1['geo1_qtd_muni_front_x_qtd_muni_tot'] = (tmp_1['qtd_municipios_faxia_fronteira'] /
        ...
        # Unir datafremes
        tmp_1 = pd.merge(
            tmp_1, tmp_1_valor_area_int_km2, on='uf', how='left')

        # Substituir valores NaN por 0
        tmp_1.fillna(0, inplace=True)

        tmp_1_AREA_SEM_CONSERVACAO = pd.read_csv(file_path_2,
                                                 # index_col=False,
                                                 usecols=[
                                                     'uf', 'area_territorial_sem_conserv_km2'],
                                                 sep=';',
                                                 encoding='Utf8')
        ...
        # Criar coluna com a cobertura de fibra por municipios
        tmp_1['geo2_area_front_x_area_tot_ori'] = (tmp_1['area_integrada_mun_faixa_fronteira_km2'] /
...
def capacidade_instalada_ANEEL_ENERG():
    ...
    try:
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['AnoReferencia',
                                    'MesReferencia'])
        ...
        tmp_1['capacidade_instalada_kW'] = tmp_1['capacidade_instalada_kW'].astype(
            str)

        # Remover/Substituir caracteres "." e "," especiais coluna  específica
        tmp_1['capacidade_instalada_kW'] = tmp_1['capacidade_instalada_kW'].str.replace(
            ',', '.')
        ...
        tmp_AREA_TERRITORIO_SEM_COMSERV = pd.read_csv(file_path_2,
                                                      # index_col=False,
                                                      usecols=['uf',
                                                               'area_territorial_sem_conserv_km2'],
                                                      sep=';',
                                                      encoding='Utf8')

        # Unir datafremes
        tmp_1 = pd.merge(tmp_1, tmp_AREA_TERRITORIO_SEM_COMSERV,
                         how='left', on='uf')

        # Criar coluna final
        tmp_1['energ'] = (tmp_1['capacidade_instalada_kW'] /
                          tmp_1['area_territorial_sem_conserv_km2'])
        ...
        print_divisor_inicio_fim(f'Arquivo {name_file_1+ext} baixado e convertido com sucesso',
                                 3)
...
def rede_pavimentada_DNIT_TRANSP():
    ...
    try:
        ...
        tmp_1 = pd.read_excel(file_path,
                              sheet_name='RESUMO SNV')

        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['Unnamed: 0',
                                    'Unnamed: 2',
                                    'Unnamed: 3',
                                    'Unnamed: 4',
                                    'Unnamed: 5',
        ...
        tmp_1['rodovias_pavimentadas'] = tmp_1['pista_simples'] + \
            tmp_1['obras_duplicacao'] + tmp_1['pista_dupla']
        ...
        tmp_AREA_TERRITORIO_SEM_COMSERV = pd.read_csv(file_path_1,
                                                      # index_col=False,
                                                      usecols=['uf',
                                                               'area_territorial_sem_conserv_km2'],
                                                      sep=';',
        ...
        # Criar coluna final
        tmp_1['transp'] = (tmp_1['rodovias_pavimentadas'] /
                           tmp_1['area_territorial_sem_conserv_km2'])
...
def var_TELECON():
    ...
    def agencias_correios_SBC_TELECON():
        ...
        try:
            ...
            tmp_1 = tabula.read_pdf(file_path,
                                    pages='all',
            ...
            # Para remover uma coluna específica, utilizamos o seguinte comando:
            tmp_1_cidade = tmp_1_cidade.drop(columns=['nome_up',
                                                      'endereco',
                                                      'bairro',
                                                      'cep'])

            # Agrupando por item e contando o número de ocorrências
            tmp_1_cidade = tmp_1_cidade.groupby(
                ['uf'])['cidade'].nunique().reset_index(name='qtd_cobertura_ag_correios_municipios')
            ...
            # Para remover uma coluna específica, utilizamos o seguinte comando:
            tmp_1_qtd = tmp_1_qtd.drop(columns=['nome_up',
                                                'endereco',
                                                'bairro',
                                                'cidade',
                                                'cep'])
            ...
            # Agrupando por item e contando o número de ocorrências
            tmp_1_qtd = tmp_1_qtd.groupby(
                ['uf']).size().reset_index(name='qtd_ag_correios_municipios')
            ...
            tmp_1_populacao = pd.read_csv(file_path_ori,
                                          # index_col=False,
            ...
            tmp_1['telecon_1_ag_correios_pop_total_mil'] = (tmp_1['qtd_ag_correios_municipios'] /
                                                            tmp_1['qtd_populacao'])*1000

            tmp_1 = coluna_escala_p_n(tmp_1,
                                      1,
                                      'telecon_1_ag_correios_pop_total_mil')

            print(tmp_1)

            # Salvar dataframe em um csv
            local_save_csv = os.path.join(os.path.join(
                path_var_output_convert, (name_file+'.csv')))
            tmp_1.to_csv(local_save_csv,
                         index=False,  # Não usar índice
                         encoding='utf-8'  # Usar formato UTF-8 para marter formatação
    ...
    def rede_fribra_otica_ANATEL_TELECON():
        ...
        try:
            ...
            # Para remover uma coluna específica, utilizamos o seguinte comando:
            tmp_1_cobert_muni = tmp_1.drop(columns=['ano',
                                                    'cod_municipio',
                                                    'prestadora',
                                                    'cnpj',
                                                    'meio_transporte'])
            ...
            # Agrupando por item e contando o número de ocorrências distintas por uf
            tmp_1_cobert_muni = tmp_1.groupby(
                ['uf'])['nome_municipio'].nunique().reset_index(name='qtd_cobertura_fibra_municipios')

            tmp_1_cobert_muni = unir_valores_linhas_df_go(tmp_1_cobert_muni,
                                                          'uf',
                                                          'DF',
                                                          'GO')
            ...
            # Para remover uma coluna específica, utilizamos o seguinte comando:
            tmp_1_qtd = tmp_1.drop(columns=['ano',
                                            'nome_municipio',
                                            'cod_municipio',
                                            'prestadora',
                                            'cnpj',
            ...
            # Agrupando por item e contando o número de ocorrências
            tmp_1_qtd = tmp_1.groupby(
                ['uf']).size().reset_index(name='qtd_fibra_municipios')

            tmp_1_qtd = unir_valores_linhas_df_go(tmp_1_qtd,
                                                  'uf',
                                                  'DF',
                                                  'GO')
            ...
            tmp_1_municipios = pd.read_csv(file_path_ori,
                                           # index_col=False,
                                           usecols=['uf', 'qtd_municipios'],
                                           sep=';',
                                           encoding='Utf8')
            ...
            # Unir datafremes
            tmp_1 = pd.merge(tmp_1_municipios, tmp_1_cobert_muni,
                             how='inner', on='uf')

            # Criar coluna com a cobertura de fibra por municipios
            tmp_1['telecon_2_cobertura_fibra'] = (tmp_1['qtd_cobertura_fibra_municipios'] /
                                                  tmp_1['qtd_municipios'])

            tmp_1 = coluna_escala_p_n(tmp_1,
                                      1,
                                      'telecon_2_cobertura_fibra')
    ...
    try:
        ...
        tmp_1 = pd.merge(
            tmp_1_correios[['uf', 'telecon_1_ag_correios_pop_total_mil']], tmp_1_fibra[['uf', 'telecon_2_cobertura_fibra']], on='uf', how='left')

        # Criar coluna final para apresentar o saneamento básico por UF, com pseo de 50% para água e 50% para esgoto
        tmp_1['telecom'] = ((tmp_1['telecon_1_ag_correios_pop_total_mil']*0.5) +
        ...
        print_divisor_inicio_fim(f'Arquivo {name_file_final+ext} baixado e convertido com sucesso',
                                 3)
...
def agua_esgoto_IBGE_SNB():
    ...
    try:
        ...
        download_arquiv_barprogress(url_api_1,
                                    name_file_1,
                                    ext,
                                    file_path_1,
                                    False)

        download_arquiv_barprogress(url_api_2,
                                    name_file_2,
                                    ext,
                                    file_path_2,
                                    False)
        ...
        with zipfile.ZipFile(file_path_1) as z_1:
            with z_1.open('Tabela 007.xlsx') as f_1:
                tmp_1 = pd.read_excel(f_1,
                                      sheet_name='Tabela 007')

        print(tmp_1)

        # Alterar o nome da coluna
        tmp_1.columns = ['nome_estado',
                         'qtd_municipios',
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['qtd_municipios',
                                    'Federal',
                                    'Estadual',
                                    'Municipal',
                                    'Privada',
        ...
        with zipfile.ZipFile(file_path_2) as z_2:
            with z_2.open('Tabela 115.xlsx') as f_2:
                tmp_2 = pd.read_excel(f_2,
                                      sheet_name='Tabela 115')

        # Alterar o nome da coluna
        tmp_2.columns = ['nome_estado',
                         'qtd_municipios',
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_2 = tmp_2.drop(columns=['qtd_municipios',
                                    'Federal',
                                    'Estadual',
                                    'Municipal',
                                    'Privada',
        ...
        tmp_3['cobertura_municipios_agua'] = (tmp_3['qtd_municipios_agua'] /
                                              tmp_3['qtd_municipios'])

        tmp_3['cobertura_municipios_esgoto'] = (tmp_3['qtd_municipios_esgoto'] /
                                                tmp_3['qtd_municipios'])
        ...
        tmp_3 = unir_valores_linhas_df_go(tmp_3,
                                          'uf',
                                          'DF',
                                          'GO')

        tmp_3 = coluna_escala_p_n(tmp_3,
                                  1,
                                  'snb')
...
def ocorrencias_criminais_MJSP_SEG():
    ...
    try:
        ...
        # Para remover uma coluna específica, utilizamos o seguinte comando:
        tmp_1 = tmp_1.drop(columns=['Cód_IBGE',
                                    'Município',
                                    'Região'])
...
def estabelecimentos_per_capita_RFB():
    ...
    try:
        ...
        print_divisor_inicio_fim(f'Verificando cnpj ativos na coluna na {base_dados} \n !!!AGUARDE!!!',
                                 1)

        # SQL para consulta da tb_rfb_estabelecimentos de cnpjs ativos e de interesse por uf
        sql_1 = (
            f'''SELECT tb_rfb_estabelecimentos.uf, count(*) as qtd_estab_ativos_cnae 
        ...
        tmp_1['estab_per_capita'] = (tmp_1['qtd_estab_ativos_cnae'] /
                                     tmp_1['qtd_populacao'])
...
def var_ECON():
    ...
    try:
        ...
        tmp_1_populacao = pd.read_csv(file_path_ori_1,
                                      # index_col=False,
                                      usecols=['uf', 'qtd_populacao'],
                                      sep=';',
                                      encoding='Utf8')

        tmp_2_pib_ind = pd.read_csv(file_path_ori_2,
                                    # index_col=False,
        ...
        # Criar coluna com de densidade de agencias por população * por 1000
        tmp_3['econ'] = ((tmp_3['pib_ind_2020']/1000) /
                         (tmp_3['qtd_populacao']))*1000
...
def tabela_var_estruturantes_final():
    ...
    name_file_ESTAB_PER_CAPITA = '17_tb_rfb_estabelecimentos_per_capita_2023.csv'
    ...
    try:
        ...
        tmp_GEO = pd.read_csv(file_path_GEO,
                              usecols=['uf', 'geo_percent_n'],
                              # index_col=False,
                              sep=';',
                              encoding='Utf8')
        ...
        tmp_ENERG = pd.read_csv(file_path_ENERG,
                                usecols=['uf', 'energ_percent_p'],
                                # index_col=False,
                                sep=';',
                                encoding='Utf8')
        ...
        tmp_TRANSP = pd.read_csv(file_path_TRANSP,
                                 usecols=['uf', 'transp_percent_p'],
                                 # index_col=False,
                                 sep=';',
                                 encoding='Utf8')
        ...
        tmp_TELECON = pd.read_csv(file_path_TELECON,
                                  usecols=['uf', 'telecom_percent_p'],
                                  # index_col=False,
                                  sep=';',
                                  encoding='Utf8')
        ...
        tmp_SNB = pd.read_csv(file_path_SNB,
                              usecols=['uf', 'snb_percent_p'],
                              # index_col=False,
                              sep=';',
                              encoding='Utf8')
        ...
        tmp_SEG = pd.read_csv(file_path_SEG,
                              usecols=['uf', 'seg_percent_p'],
                              # index_col=False,
                              sep=';',
                              encoding='Utf8')
        ...
        tmp_ESTAB_PER_CAPITA = pd.read_csv(file_path_ESTAB_PER_CAPITA,
                                           usecols=[
                                               'uf', 'estab_per_capita_percent_p'],
                                           # index_col=False,
                                           sep=';',
                                           encoding='Utf8')
        ...
        tmp_ECON = pd.read_csv(file_path_ECON,
                               usecols=['uf', 'econ_percent_p'],
                               # index_col=False,
                               sep=';',
                               encoding='Utf8')
        ...
        # Remover coluna UF
        tmp_1_sem_uf = tmp_1.drop('uf', axis=1)

        # Crie um objeto PCA com o número desejado de componentes principais com a dimensão desejada:
        pca = PCA(n_components=1)

        # Ajuste o modelo PCA aos seus dados e transforme-os para obter os componentes principais:
        principal_components = pca.fit_transform(tmp_1_sem_uf)

        # Crie um novo dataframe com os componentes principais:
        tmp_1_df = pd.DataFrame(data=principal_components, columns=['PC1'])

        # Junte o novo dataframe com o dataframe original para adicionar as novas colunas:
        tmp_1_final_df = pd.concat([tmp_1, tmp_1_df], axis=1)

        # Alterar o nome das colunas
        tmp_1_final_df.columns = ['uf',
                                  'geo_percent_n',
                                  'energ_percent_p',
                                  'transp_percent_p',
                                  'telecom_percent_p',
                                  'snb_percent_p',
                                  'seg_percent_p',
                                  'estab_per_capita_percent_p',
                                  'econ_percent_p',
                                  'infra']

        tmp_1_final_df = coluna_escala_p_n(tmp_1_final_df,
                                           1,
                                           'infra')

        # Ordenar ascendente coluna específica para facilitar a visualização.
        tmp_1_final_df = tmp_1_final_df.sort_values(
            by='infra_percent_p', ascending=False)

        print(tmp_1_final_df)

        # Salvar dataframe em um csv
        tmp_1_final_df.to_csv(file_path_final,
                              index=False,  # Não usar índice
                              encoding='utf-8'  # Usar formato UTF-8 para marter formatação
                              , sep=';'  # Usar ponto e virgula
                              , na_rep='0')  # Susbstituir NaN por 0

        print_divisor_inicio_fim(f'Arquivo {name_file_final} baixado e convertido com sucesso',
                                 3)
...
def sequencia_agregados_IBGE():
    ...
    try:
        ...
        funçao_barprogress([quantidade_populacao_IBGE,
